  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append('<div style="display:block;text-align:center;padding:6em;"><p style="">Wechsle in den Fullscreen-Modus.</p><button id="jspsych-fullscreen-btn" class="jspsych-btn">Starten</button></div>');
