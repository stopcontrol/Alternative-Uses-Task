    ...
    jsPsych['survey-text2'] = (function() {
        ...
        plugin.trial = function(display_element, block, trial, part) {
            ...
            for (var i = 0; i < trial.questions.length; i++) {
				...
				var df = 'Category '+ (block.trial_idx+1) +' / 4 :';
                // add question text
                $("#surveytext" + i).append('<p> ' + df + '</p>');
				$("#surveytext" + i).append('<p> <strong> <font size="5"  class="surveytext"  </font size>' + trial.questions[i] + '</strong></p>');
				$("#surveytext" + i).append('<p> Liste so viele kreative Ideen wie m&oumlglich auf (<i>und trenne sie durch Kommatas</i>):</p>');
                // add text box
				...
				$("#surveytext" + i).append(' <font size="3" color="black">Restliche Zeit bis zur n&aumlchsten Kategorie:</font>');
